# %% [code]
---
title: "National Footprint Accounts 2014 data analysis (2018 release)"
date: "22/07/2019"
output:
  html_document:
  toc: TRUE
...
There are 14 countries with no information for the GDP per Capita.

Some missing values for theses countries might find an explanation in the political situation (Eritrea, North Korea), the War (Syria, Somalia).
