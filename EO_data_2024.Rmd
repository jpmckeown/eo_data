...
I did this last after collecting GFN data, if it was done earlier should refer to eo_2024
```{r}
...
eo_2024_gfn <- eo_2024_gfn %>% 
  ...
  select(
    ...
    SP.DYN.TFRT.IN, # inserting TFR column here
...
# eo_2023 <- readRDS('data/eo_2023_order.rds')
# colnames(eo_2023)

# grades <- eo_2023 %>% 
#   select(iso3c, Rank_sustain_2020)
# 
# eo_2024_beforeGrade <- eo_2024_gfn # preserve
# 
# eo_2024 <- eo_2024_gfn %>% 
...
eo_2024_Grade <- eo_2024_gfn %>%
  ...
  select(
    Country, Continent, Photos, iso2c, iso3c, 
    Grade_2021, # Move this column here
...
```{r echo = FALSE, eval = FALSE}
eo_2024 <- readRDS('data/eo_2024.rds')
```

Archive and export for web sheet
or use this in {r } to stop export: echo = FALSE, eval = FALSE
```{r}
saveRDS(eo_2024, file="data/eo_2024.rds")
write_csv(eo_2024, "data/eo_2024.csv")
```